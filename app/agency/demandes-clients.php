...
$demandes = get_agency_demandes($pdo, $agence_id, $filtre_statut);
...
<link rel="stylesheet" href="assets/css/demandes-clients.css">

<?php
include __DIR__ . '/layouts/header.php';
include __DIR__ . '/layouts/main-demandes-clients.php';
