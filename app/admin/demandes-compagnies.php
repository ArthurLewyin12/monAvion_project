...
$demandes = get_demandes_compagnies($pdo, $statut_filter);
...
$page_title = "Demandes de compagnies";
$current_page = "demandes-compagnies";
$breadcrumb = [
    ['label' => 'Dashboard', 'url' => 'dashboard.php'],
    ['label' => 'Demandes Compagnies']
];
?>
...
<div class="admin-container">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Demandes de compagnies aériennes</h1>
            <p class="page-subtitle">Valider ou rejeter les demandes d'inscription de compagnies</p>
        </div>
    </div>
    ...
    <div class="stats-grid-3">
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                <p class="stat-label">Total Compagnies</p>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-value">
                    <?php
                    $stmt = $pdo->query("SELECT COUNT(*) FROM demandes_compagnie WHERE statut_demande = 'REJETEE'");
            ...
            <div class="filters-tabs">
                <a href="?statut=EN_ATTENTE" class="filter-tab <?= $statut_filter === 'EN_ATTENTE' ? 'active' : '' ?>">
                    ...
                    <?php if ($stats['demandes_compagnies_attente'] > 0): ?>
                        <span class="tab-badge"><?= $stats['demandes_compagnies_attente'] ?></span>
                    <?php endif; ?>
                </a>
                        ...
                        <div class="demande-card">
                            <div class="demande-header">
                                <div class="demande-info">
                                    <h3 class="demande-nom"><?= htmlspecialchars($demande['nom_compagnie']) ?></h3>
                            ...
                            <div class="demande-body">
                                <div class="demande-details">
                                    <div class="detail-item">
                                        ...
                                        <div>
                                            <p class="detail-label">Code IATA</p>
                                            <p class="detail-value"><strong><?= htmlspecialchars($demande['code_iata']) ?></strong></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div>
                                            <p class="detail-label">Code OACI</p>
                                            <p class="detail-value"><strong><?= htmlspecialchars($demande['code_oaci']) ?></strong></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <div>
                                            <p class="detail-label">Siège social</p>
                                            <p class="detail-value"><?= htmlspecialchars($demande['siege_social']) ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <?php if ($demande['numero_certification']): ?>
                                        <div class="detail-item">
                                            <svg class="detail-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div>
                                                <p class="detail-label">Numéro de certification</p>
                                                <p class="detail-value"><?= htmlspecialchars($demande['numero_certification']) ?></p>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <?php if ($demande['statut_demande'] === 'EN_ATTENTE'): ?>
                                <div class="demande-actions">
                                    <button class="btn btn-success" onclick="openValidateModal(<?= $demande['id_demande'] ?>, '<?= htmlspecialchars($demande['nom_compagnie'], ENT_QUOTES) ?>')">
                                    ...
                                    <button class="btn btn-error" onclick="openRejectModal(<?= $demande['id_demande'] ?>, '<?= htmlspecialchars($demande['nom_compagnie'], ENT_QUOTES) ?>')">
                                        <svg class="btn-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/>
                                            <path d="M15 9L9 15M9 9L15 15" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                                        </svg>
...
<div id="validateModal" class="modal">
    <div class="modal-content modal-content-sm">
        ...
        <form method="POST" action="/src/controllers/admin/valider_demande_compagnie.php">
            <div class="modal-body">
                ...
                <div class="alert alert-success">
                    ...
                    <div>
                        En validant cette demande, vous allez créer une nouvelle compagnie et l'utilisateur recevra un email de confirmation.
                    </div>
                </div>
